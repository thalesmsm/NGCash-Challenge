    ...
    <div>
      ...
      <main>
        <div className="w-full max-w-xs mx-auto md:max-w-none md:flex md:justify-around md:items-center">
          ...
          <form className="flex flex-col justify-center bg-white/60 shadow-md rounded-lg px-8 h-[430px]">
            <div className="mb-6">
            ...
            <div className="flex items-center justify-between">
              <button
                className="bg-gradient-to-br from-gray-900 to-gray-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                type="button"
                >
                Entrar
              </button>
              <button className="bg-gradient-to-br from-gray-900 to-gray-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                Cadastrar
              </button>
            </div>
          </form>
